...
import { fetchallProductbyFilter } from "../../product/productListSlice";
...
import { selectProduct, selectTotalItem } from "../../product/productListSlice";
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div>
                <Link 
                to="/admin/productform" className="w-40 flex mx-8 items-center justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700"> Add New Product</Link>
              </div>
                {/* Products section ----------------------------------------------------------------------------------------*/}
          ...
          {products.map((product, ind) => (
            <div>
              <Link to={`/productdetails/${product.id}`} key={ind}>
                <div className="group relative border-2 rounded-md">
                  ...
                  <div className="mt-4 mx-2 my-2 flex justify-between">
                    <div>
                  ...
                  {product.deleted && <p className=" text-red-600 text-sm mx-2 my-2">This Item is Deleted</p>}
                </div>
              </Link>
              <div>
                <Link to={'/admin/productform/edit/'+product.id} className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 mt-2 text-xs font-medium text-white shadow-sm hover:bg-indigo-700"> Edit Product</Link>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
          <p className="text-sm text-gray-700">
            ...
            to{" "}
            <span className="font-medium">
              {page * PAGE_DATA_LIMIT > totalItem
                ? `${totalItem}`
                : `${page * PAGE_DATA_LIMIT}`}
            </span>{" "}
